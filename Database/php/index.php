        ...
        <div id = "main"><!--bao toàn bộ khung website-->
            ...
            <div id ="menutop"><!--phần Menutop-->
                <ul>
                    ...
                    <li><a href="#">Tin dự án</a></li>
                    <li><a href="#">Các hoạt động</a></li>
                    <li><a href="#">Cơ cấu sách</a></li>
          ...
          <div class="container">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
              <div class="col">
                ...
                <svg class="bd-placeholder-img card-img-top" width="100%" height="225" img="./img/tải xuống.jpeg" ></svg> <!--dòng này giống dòng 64 do t xóa để test-->
