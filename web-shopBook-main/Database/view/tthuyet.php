...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
  ...
  <path d="M0 2.5A.5.5 0 0 1 .5 2H2a.5.5 0 0 1 .485.379L2.89 4H14.5a.5.5 0 0 1 .485.621l-1.5 6A.5.5 0 0 1 13 11H4a.5.5 0 0 1-.485-.379L1.61 3H.5a.5.5 0 0 1-.5-.5zM3.14 5l.5 2H5V5H3.14zM6 5v2h2V5H6zm3 0v2h2V5H9zm3 0v2h1.36l.5-2H12zm1.11 3H12v2h.61l.5-2zM11 8H9v2h2V8zM8 8H6v2h2V8zM5 8H3.89l.5 2H5V8zm0 5a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0zm9-1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm-2 1a2 2 0 1 1 4 0 2 2 0 0 1-4 0z"/>
            ...
            <div class="container"> <!--Bìa quảng cáo-->
                <img src="../img/tieuthuyet.jpg" width="100%" height="350px" >
            </div>
          ...
          <div class="container">
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
              <div class="col">
                ...
                <img src="../img/tt1.jpg" width="350" height="255" > <!--dòng này là để ảnh-->
                 
                  <div class="card-body">
                    <p class="card-text"> Tiểu Thuyết<br>Harry Potter và chiếc cốc lửa</p>
                    <b><i style="color:red;">đ 350.000</i></b>
              ...
              <div class="col">
                <div class="card shadow-sm">
                   <img src="../img/tt2.jpg" width="350" height="250" > <!--dòng này là để ảnh-->
                 
                 <div class="card-body">
                   <p class="card-text"> Tiểu Thuyết<br>Harry Postter và hoàng tử lai </p>
                   <b><i style="color:red;">đ 300.000</i></b>
                   <div class="d-flex justify-content-between align-items-center">
                     <div class="btn-group">
                     <a href="../page/giohang.php"> <button type="button" class="btn btn-sm btn-outline-secondary">giỏ hàng</button> </a> 
                       <button type="button" class="btn btn-sm btn-outline-secondary">đặt hàng</button>
              ...
              <div class="col">
                <div class="card shadow-sm">
                <img src="../img/tt3.jpg" width="350" height="255" > <!--dòng này là để ảnh-->
                 
                 <div class="card-body">
                   <p class="card-text"> Tiểu Thuyết<br>Chiết chi</p>
              ...
              <div class="col">
                ...
                <img src="../img/TVH3.jpg" width="350" height="255" > <!--dòng này là để ảnh-->
                 ...
                 <div class="card-body">
                   <p class="card-text">Tiểu thuyết <br> Độc thầm</p>
              ...
              <div class="col">
                <div class="card shadow-sm">
                <img src="../img/tt4.jpg" width="350" height="255" > <!--dòng này là để ảnh-->
                 
                 <div class="card-body">
                   <p class="card-text"> Tiểu Thuyết<br>Hệ thống tự cứu của nhân vật phản diện tập1</p>
                   <b><i style="color:red;">đ 168.000</i></b>
                   <div class="d-flex justify-content-between align-items-center">
                     <div class="btn-group">
                     <a href="../page/giohang.php"> <button type="button" class="btn btn-sm btn-outline-secondary">giỏ hàng</button> </a>
                       <button type="button" class="btn btn-sm btn-outline-secondary">đặt hàng</button>
              ...
              <div class="col">
                <div class="card shadow-sm">
                <img src="../img/tt6.jpg" width="350" height="255" > <!--dòng này là để ảnh-->
                 
                 <div class="card-body">
                   <p class="card-text">  Tiểu Thuyết<br>Hầu môn kiều nữ</p>
              ...
              <div class="col">
                <div class="card shadow-sm">
                   <img src="../img/tt7.jpg" width="350" height="250" > <!--dòng này là để ảnh-->
                    <div class="card-body">
                   <p class="card-text">Tiểu thuyết<br>Tam sinh tam thế thập lý đào hoa </p>
                   <b><i style="color:red;">đ 123.000</i></b>
                   <div class="d-flex justify-content-between align-items-center">
                     <div class="btn-group">
                     <a href="../page/giohang.php"> <button type="button" class="btn btn-sm btn-outline-secondary">giỏ hàng</button> </a>
                       <button type="button" class="btn btn-sm btn-outline-secondary">đặt hàng</button>
              ...
              <div class="col">
                <div class="card shadow-sm">
                 ...
                 <div class="card-body">
                   <p class="card-text">Tiểu thuyết <br> Thiên quan tứ phúc tập 3</p>
              ...
              <div class="col">
                <div class="card shadow-sm">
                   <img src="../img/tt8.jpg" width="350" height="250" > <!--dòng này là để ảnh-->
                 
                 <div class="card-body">
                   <p class="card-text">Tiểu thuyết<br> Đạo mộ bút ký</p>
                   <b><i style="color:red;">đ 250.000</i></b>
                   <div class="d-flex justify-content-between align-items-center">
                     <div class="btn-group">
                     <a href="../page/giohang.php"> <button type="button" class="btn btn-sm btn-outline-secondary">giỏ hàng</button> </a> 
                       <button type="button" class="btn btn-sm btn-outline-secondary">đặt hàng</button>
              ...
              <div class="col">
                ...
                <img src="../img/TVH4.jpg" width="350" height="255" > <!--dòng này là để ảnh-->
                 ...
                 <div class="card-body">
                   <p class="card-text">Tiểu thuyết <br> Hoàn khố</p>
              ...
              <div class="col">
                <div class="card shadow-sm">
                <img src="../img/tt10.jpg" width="350" height="255" > <!--dòng này là để ảnh-->
                 
                 <div class="card-body">
                   <p class="card-text">Tiểu thuyết<br>Hiệp khách hành </p>
                   <b><i style="color:red;">đ 127.000</i></b>
                   <div class="d-flex justify-content-between align-items-center">
                     <div class="btn-group">
                     <a href="../page/giohang.php"> <button type="button" class="btn btn-sm btn-outline-secondary">giỏ hàng</button> </a> 
                       <button type="button" class="btn btn-sm btn-outline-secondary">đặt hàng</button>
